...
function SignupPM({setLoginUser}) {
      ...
      <div className = "container">
        <div className="blueBg">
          <div className="box signin">
            ...
            <button className="signinBtn" onClick = {LoginEvent}>Sign in</button>
          </div>
          <div className="box signup">
            <h2>Don't Have An Account?</h2>
            <button className="signupBtn" onClick = {RegisterEvent}>Sign up</button>
          </div>
        </div>
